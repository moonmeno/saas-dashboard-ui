...
export const YoutubeIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" {...props}>
    <path d="M21.8 8.001a2.75 2.75 0 0 0-1.94-1.948C18 5.5 12 5.5 12 5.5s-6 0-7.86.553A2.75 2.75 0 0 0 2.2 8.001 29.7 29.7 0 0 0 1.5 12a29.7 29.7 0 0 0 .7 3.999 2.75 2.75 0 0 0 1.94 1.948C6 18.5 12 18.5 12 18.5s6 0 7.86-.553a2.75 2.75 0 0 0 1.94-1.948A29.7 29.7 0 0 0 22.5 12a29.7 29.7 0 0 0-.7-3.999Z" />
    <path d="m10 15 5-3-5-3v6Z" fill="var(--brand-contrast)" />
  </svg>
);
...
export const SunIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" aria-hidden="true" {...props}>
    <circle cx="12" cy="12" r="4" />
    <path d="M12 2v2m0 16v2m10-10h-2M4 12H2m16.95 7.05-1.41-1.41M6.46 6.46 5.05 5.05m12.9 0-1.41 1.41M6.46 17.54 5.05 18.95" />
  </svg>
);
...
export const FlagIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}>
    <path d="M4 4h7l1 2h8l-1 5h-7l-1-2H4v11" />
  </svg>
);
