    ...
    <div className="grid gap-6 lg:grid-cols-[360px_1fr]">
      ...
      <section className="card-surface hidden h-full flex-col lg:flex">
        <div className="flex items-center justify-between border-b border-white/10 px-6 py-4">
          <div>
            <h3 className="text-lg font-semibold text-[var(--text)]">Thread details</h3>
        ...
        {selectedThread ? (
          <div className="flex flex-wrap items-center gap-2 border-t border-white/10 bg-[var(--surface-2)] px-6 py-4">
            ...
            <Button variant="secondary" className="min-h-[44px]">
              <ShieldIcon className="mr-2 h-4 w-4" /> Hold
            </Button>
            <Button variant="secondary" className="min-h-[44px]">
              <ShieldIcon className="mr-2 h-4 w-4" /> Mark spam
            </Button>
            <Button variant="secondary" className="min-h-[44px]">
              <ShieldIcon className="mr-2 h-4 w-4" /> Publish
            </Button>
            <Button variant="secondary" className="min-h-[44px]">
