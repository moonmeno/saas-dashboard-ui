...
const YoutubeVideos = () => {
  ...
  const selection = useAppStore((state) => state.selections.youtube);
  ...
  return (
    <div className="space-y-6">
      <FilterBar
        ...
        onSearchChange={(value) => updateSelection("youtube", { searchQuery: value })}
        viewMode={selection.contentViewMode}
        onViewModeChange={(mode) => updateSelection("youtube", { contentViewMode: mode })}
        platform="youtube"
      />
